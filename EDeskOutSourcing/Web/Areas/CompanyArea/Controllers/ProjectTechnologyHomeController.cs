...
namespace Web.Areas.CompanyArea.Controllers
{
    ...
    public class ProjectTechnologyController : Controller
    {
        ...
        public ProjectTechnologyController(IProjectTechnologyRepo repo)
        {
            this.repo = repo;
        }
        ...
        [HttpPost]
        public IActionResult Create(ProjectTechnology rec)
        {
        ...
        [HttpPost]
        public IActionResult Edit(ProjectTechnology rec)
        {
            if (ModelState.IsValid)
            {
                this.repo.Edit(rec);
